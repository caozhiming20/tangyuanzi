function showTime() { 
	...
	var startDate = new Date(2009, 02, 02);
	...
	var currentTimeString = "Dear:<br>"
		+ "We have become classmates for :<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----caozhimin   2018-01-29</c>";
